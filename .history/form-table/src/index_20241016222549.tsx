...
const ExampleComponent = (props: ComponentProps, ref: React.Ref<any>) => {
...
xhr.open("GET", `https://proapi.azurewebsites.net/api/rule?token = 123&current=1&pageSize=100` ?? `https://${api}/${name}${id}`, true);
